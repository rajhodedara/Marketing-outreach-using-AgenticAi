...
export type StepStatus = 'pending' | 'active' | 'completed' | 'flagged';
    ...
    <div className="flex flex-col gap-6 relative px-4 py-6">
      ...
      {steps.map((step, index) => {
        ...
        if (step.status === 'completed') {
          ...
          icon = <span className="material-symbols-outlined text-[12px] text-white font-bold">priority_high</span>;
        }

    ...
    <div className="flex flex-col gap-6 relative px-4 py-6">
      ...
      {steps.map((step, index) => {
        ...
        if (step.status === 'completed') {
          ...
          icon = <MagnifyingGlass weight="bold" size={14} className="text-white" />; // Different icon for Luna's flag
        }
        ...
        return (
          <motion.div 
            ...
            transition={{ type: "spring" as any, stiffness: 100, damping: 20, delay: index * 0.1 }}

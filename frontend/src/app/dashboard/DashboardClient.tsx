...
export default function DashboardClient() {
  ...
  const { data, isLoading: loading } = useQuery({
    queryKey: ['accounts'],
    queryFn: async () => {
      // Relative URL will not work reliably in a Client component if we are relying on RSC prefetching 
      // without setting the backend URL properly in some cases. However, next.js rewrites should handle it.
